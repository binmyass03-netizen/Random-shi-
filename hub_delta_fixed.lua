...
if not getupvalue then getupvalue = function() return nil end end
if not setfpscap then setfpscap = function() end end
if not getfenv then getfenv = function() return _ENV or {} end end
...
if not debug.getupvalue then debug.getupvalue = function() return nil end end
if not raknet then raknet = {add_send_hook=function()end, desync=function()end} end
if not buffer then buffer = {writeu32=function()end} end
-- ─────────────────────────────────────────────────────────────────────────────
